...
void	get_color(t_pixel pixel, t_pixel *p, t_data *d, double d_to_l)
{
	...
	if (angle < 0)
		angle = 0;
	// printf("ambient : %d, %d, %d ; scaler : %f; d_to_l : %f;\n", \
	// p->color.r, p->color.g, p->color.b, pixel.scaler, d_to_l);
	// p->color.r = (d->ambient->color.r * d->ambient->ratio / 255) * p->color.r;
	// p->color.g = (d->ambient->color.g * d->ambient->ratio / 255) * p->color.g;
	// p->color.b = (d->ambient->color.b * d->ambient->ratio / 255) * p->color.b;
	// printf("pixel: %d, %d. %d\n", p->color.r, p->color.g, p->color.b);
	// printf("pixel.el: %d, %d. %d\n", pixel.color.r, pixel.color.g, pixel.color.b);
	color_ratio.x = (double)p->color.r / 255;
	color_ratio.y = (double)p->color.g / 255;
	color_ratio.z = (double)p->color.b / 255;
	ret.r = color_ratio.x * d->ambient->color.r * d->ambient->ratio;
	ret.g = color_ratio.y * d->ambient->color.g * d->ambient->ratio;
	ret.b = color_ratio.z * d->ambient->color.b * d->ambient->ratio;
	if (pixel.scaler > d_to_l || pixel.scaler < 0)
	{
		ret.r += color_ratio.x * d->light->color.r * d->light->ratio * angle;
		ret.g += color_ratio.y * d->light->color.g * d->light->ratio * angle;
		ret.b += color_ratio.z * d->light->color.b * d->light->ratio * angle;
	}
	// p->color.r += (d->light->color.r * d->light->ratio / 255) * pixel.color.r;
	// p->color.g += (d->light->color.g * d->light->ratio / 255) * pixel.color.g;
	// p->color.b += (d->light->color.b * d->light->ratio / 255) * pixel.color.b;
		// printf("diffuse : %d, %d, %d ; scaler : %f; d_to_l : %f;\n", \
		// p->color.r, p->color.g, p->color.b, pixel.scaler, d_to_l);
	p->color.r = ret.r;
	p->color.g = ret.g;
	p->color.b = ret.b;
